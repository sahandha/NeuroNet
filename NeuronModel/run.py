...
def main(argv):
    ...
    if fromFile:
        ...
        brain = NeuronModel(N=N, tend=10, I=0, connectionscale=connectionscale, synapselimit=synapselimit, synapsestrengthlimit=synapselimit,networkdevel=NetworkDevel,
