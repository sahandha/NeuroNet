...
def main(argv):
    ...
    if fromFile:
        ...
        brain = NeuronModel(N=N, tend=Tend, I=0, connectionscale=connectionscale, synapselimit=synapselimit, synapsestrengthlimit=synapselimit, networkdevel=NetworkDevel,C=C,gL=gL,gCa=gCa,gK=gK,VL=VL,VCa=VCa,VK=VK,V1=V1,V2=V2,V3=V3,V4=V4,phi=phi,
